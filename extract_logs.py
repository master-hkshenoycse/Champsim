...
import pandas as pd
import os
log_location="/mnt/c/MTP_ORGINAL/logs_final"
no_of_inst=100000000
...
folder_loc=['lru_noninclusive','lru_exclusive','lru_exclusive_rigid','drrip_noninclusive','drrip_exclusive','drrip_reexclusive']
...
df.to_csv(log_location+'_collated_results_policy_speedup_20240210.csv')
