...
bin/champsim_ship: $(patsubst %.cc,%.o,$(wildcard src/*.cc)) obj/repl_rreplacementDship.a obj/pref_pprefetcherDno.a obj/repl_rreplacementDlru.a obj/pref_pprefetcherDno_instr.a obj/bpred_bbranchDbimodal.a obj/btb_bbtbDbasic_btb.a
